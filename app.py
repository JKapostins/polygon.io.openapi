...
# 1.) Parse the html document found at https://polygon.io/docs/stocks/getting-started and extract the anchors out of the first <nav/> element. These anchors will be our urls for differnet documentations (stocks, forex, crypto, etc.)
...
def extract_documentation_urls():
    ...
    nav_element = soup.find('nav')  # Assuming the first nav element contains the anchors
    anchors = nav_element.find_all('a', href=True)
