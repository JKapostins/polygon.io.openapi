...
def create_modular_reference(output_dir, sections):
    ...
    for section in sections:
        ...
        # Ensure overview files appear first
        overview_files = [file for file in rest_md_files if 'overview' in file]
        rest_md_files = sorted(overview_files) + sorted(file for file in rest_md_files if 'overview' not in file)
        ...
        # Ensure overview files appear first
        overview_files = [file for file in websocket_md_files if 'overview' in file]
        websocket_md_files = sorted(overview_files) + sorted(file for file in websocket_md_files if 'overview' not in file)
